...
<div class="fieldcontain ${hasErrors(bean: personCoreInstance, field: 'uid', 'error')} ">
	<label for="uid">
...
<div class="fieldcontain ${hasErrors(bean: personCoreInstance, field: 'name', 'error')} ">
	<label for="name">
		<g:message code="personCore.name.label" default="Name" />
		
	</label>
	<g:textField name="name" value="${personCoreInstance?.name}"/>
</div>
