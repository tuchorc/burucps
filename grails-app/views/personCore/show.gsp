	...
	<body>
		...
		<div id="show-personCore" class="content scaffold-show" role="main">
			...
			<ol class="property-list personCore">
				...
				<g:if test="${personCoreInstance?.personId}">
				<li class="fieldcontain">
					<span id="personId-label" class="property-label"><g:message code="personCore.personId.label" default="Person Id" /></span>
					
						<span class="property-value" aria-labelledby="personId-label"><g:fieldValue bean="${personCoreInstance}" field="personId"/></span>
				...
				<li class="fieldcontain">
					<span id="dateOfBirth-label" class="property-label"><g:message code="personCore.dateOfBirth.label" default="Date Of Birth" /></span>
					
						<span class="property-value" aria-labelledby="dateOfBirth-label"><g:formatDate date="${personCoreInstance?.dateOfBirth}" /></span>
				...
				<li class="fieldcontain">
					<span id="creationDate-label" class="property-label"><g:message code="personCore.creationDate.label" default="Creation Date" /></span>
					
						<span class="property-value" aria-labelledby="creationDate-label"><g:formatDate date="${personCoreInstance?.creationDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="createdBy-label" class="property-label"><g:message code="personCore.createdBy.label" default="Created By" /></span>
					
						<span class="property-value" aria-labelledby="createdBy-label"><g:fieldValue bean="${personCoreInstance}" field="createdBy"/></span>
				...
				<li class="fieldcontain">
					<span id="lastUpdateDate-label" class="property-label"><g:message code="personCore.lastUpdateDate.label" default="Last Update Date" /></span>
					
						<span class="property-value" aria-labelledby="lastUpdateDate-label"><g:formatDate date="${personCoreInstance?.lastUpdateDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="lastUpdateBy-label" class="property-label"><g:message code="personCore.lastUpdateBy.label" default="Last Update By" /></span>
					
						<span class="property-value" aria-labelledby="lastUpdateBy-label"><g:fieldValue bean="${personCoreInstance}" field="lastUpdateBy"/></span>
				...
				<li class="fieldcontain">
					<span id="roles-label" class="property-label"><g:message code="personCore.roles.label" default="Roles" /></span>
						...
						<span class="property-value" aria-labelledby="roles-label"><g:link controller="abstractPersonRole" action="show" id="${r.id}">${r?.encodeAsHTML()}</g:link></span>
						</g:each>
