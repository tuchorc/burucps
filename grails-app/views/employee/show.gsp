	...
	<body>
		...
		<div id="show-employeeCore" class="content scaffold-show" role="main">
			...
			<ol class="property-list employeeCore">
				...
				<g:if test="${employeeCoreInstance?.employeeNumber}">
				<li class="fieldcontain">
					<span id="employeeNumber-label" class="property-label"><g:message code="employeeCore.employeeNumber.label" default="Employee Number" /></span>
					
						<span class="property-value" aria-labelledby="employeeNumber-label"><g:fieldValue bean="${employeeCoreInstance}" field="employeeNumber"/></span>
				...
				<li class="fieldcontain">
					<span id="roles-label" class="property-label"><g:message code="employeeCore.roles.label" default="Roles" /></span>
						...
						<span class="property-value" aria-labelledby="roles-label"><g:link controller="abstractEmployeeRole" action="show" id="${r.id}">${r?.encodeAsHTML()}</g:link></span>
						</g:each>
