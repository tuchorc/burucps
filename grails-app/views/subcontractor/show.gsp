			...
			<ol class="property-list subcontractor">
				...
				<li class="fieldcontain">
					<span id="organization-label" class="property-label"><g:message code="subcontractor.organization.label" default="Organization" /></span>
						...
						<span class="property-value" aria-labelledby="organization-label"><g:link controller="organizationCore" action="show" id="${subcontractorInstance?.organization?.id}">${subcontractorInstance?.organization?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="businessUnit-label" class="property-label"><g:message code="subcontractor.businessUnit.label" default="Business Unit" /></span>
					
						<span class="property-value" aria-labelledby="businessUnit-label"><g:link controller="businessUnit" action="show" id="${subcontractorInstance?.businessUnit?.id}">${subcontractorInstance?.businessUnit?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="transactions-label" class="property-label"><g:message code="subcontractor.transactions.label" default="Transactions" /></span>
						...
						<span class="property-value" aria-labelledby="transactions-label"><g:link controller="salesTransaction" action="show" id="${t.id}">${t?.encodeAsHTML()}</g:link></span>
						</g:each>
