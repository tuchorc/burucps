		...
		<div id="list-person" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="uid" title="${message(code: 'person.uid.label', default: 'Uid')}" />
				...
				<g:each in="${personInstanceList}" status="i" var="personInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${personInstance.id}">${fieldValue(bean: personInstance, field: "uid")}</g:link></td>
